...
import HeaderHalber from "./HeaderHalber/HeaderHalber";
import FeatureHalber from "./FeatureHalber/FeatureHalber";
...
function App() {
  ...
  return (
      <div>
        <HeaderHalber name={"Emilia Clark"} fonction={"Actress"}/>
